...
<div class="container-fluid terms">
  <div class="col-10 offset-1">
    ...
    <h3 class="border p-1">第1条（個人情報）</h3 class="border p-1">
    <p>「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>

    <h3 class="border p-1">第2条（個人情報の収集方法）</h3 class="border p-1">
    ...
    <h3 class="border p-1">第3条（個人情報を収集・利用する目的）</h3 class="border p-1">
    ...
    <h3 class="border p-1">第4条（利用目的の変更）</h3 class="border p-1">
    <ol>
    ...
    <h3 class="border p-1">第5条（個人情報の第三者提供）</h3 class="border p-1">
    <ol>
    ...
    <h3 class="border p-1">第6条（個人情報の開示）</h3 class="border p-1">
    <ol>
    ...
    <h3 class="border p-1">第7条（個人情報の訂正および削除）</h3 class="border p-1">
    <ol>
    ...
    <h3 class="border p-1">第8条（個人情報の利用停止等）</h3 class="border p-1">
    <ol>
    ...
    <h3 class="border p-1">第9条（プライバシーポリシーの変更）</h3 class="border p-1">
    <ol>
