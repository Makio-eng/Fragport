...
<div class="user-profile-info container">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <div class="row">
        <div class="col-4 offset-8 mt-0 mb-2">
          <a href="{{ action('User\ProfileController@edit',['id' => $user->id])}}" class="profile-edit-link mx-auto">
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <div class="row py-3">
                ...
                <div class="col-lg-5">
                  <div class="row">
                    <a href="{{ action('User\ReviewController@edit',['id'=>$review->id])}}" class="ml-auto review-edit-link">
